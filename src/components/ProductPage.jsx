...
const ProductPage = () => {
  ...
  return (
    <>
      ...
      <div
        ref={pageRef}
        className={`hidden sm:flex w-full min-h-screen pt-32 pb-16 flex-col gap-5 overflow-${overflowStyle}`}
      >
        <div className="w-fit absolute top-1/2 right-[50%] translate-x-1/2 -translate-y-1/2">
          <div className="relative">
            <img
              ref={svgRef}
              className="w-[40vw]"
              src={`https://ox-admin.wtmmedia.com/${outerImage}`}
              alt="svgElem"
            />
          </div>
        </div>
        ...
        <div className="w-full flex justify-start items-end pl-6">
          <h1
            ...
            className="text-4xl font-bold text-[#FFA500]"
          >
            {cableName}
          </h1>
        </div>
        ...
        <div ref={controlOuterSvgRef} className="">
          <img
            className="mix-blend-overlay contrast-125 brightness-110"
            src={`https://ox-admin.wtmmedia.com/${wireImage}`}
            alt="outer-cable-img"
          />
        </div>
        ...
        <div className="w-full flex justify-between px-16 mt-8">
          <div className="flex flex-col overflow-hidden w-1/2">
            <h1 ref={headingRef} className="text-[#272880] font-bold text-2xl">
              APPLICATION
            </h1>
            ...
            <div ref={contentRef} className="flex flex-col w-[30vw]">
              <div
                ...
                dangerouslySetInnerHTML={{ __html: applications }}
              />
            </div>
          </div>

          <div className="w-1/2 flex flex-col overflow-hidden">
            <h1 ref={heading1Ref} className="text-[#272880] font-bold text-2xl">
              PRODUCT FEATURES
            </h1>
        ...
        <div className="w-full flex justify-between px-16 mt-8">
          <div className="w-1/2 flex flex-col gap-1">
            <h1 ref={heading2Ref} className="text-[#272880] font-bold text-2xl">
              PRODUCT BUILD UP
            </h1>
          ...
          <div className="w-1/2 flex flex-col gap-1 pr-10 overflow-hidden">
            <h1 ref={heading3Ref} className="text-[#272880] font-bold text-2xl">
              APPROVALS
            </h1>
            ...
            <div ref={content3Ref} className="flex items-center gap-1">
              ...
              <p className="text-black text-lg">
                Using RoHS* Compliances compounds
              </p>
            </div>
            <div className="mt-2">
              <img
                ref={imgRef}
                src={`https://ox-admin.wtmmedia.com/${approvalImage}`}
                alt="ox-control-10-approval"
                className="block"
              />
            </div>
        ...
        <div className="w-full grid grid-cols-1 px-16 mt-8 overflow-hidden">
          <div className="w-full flex flex-col">
            ...
            <div ref={content4Ref} className="flex flex-col gap-2">
              <div
                className="flex flex-col"
                dangerouslySetInnerHTML={{ __html: applicationStandard }}
              />
            </div>
          </div>
        </div>
      ...
      {/* Mobile */}
      <div
        className={`flex sm:hidden w-full min-h-screen pt-20 pb-16 flex-col gap-5 overflow-${overflowStyle}`}
      >
        {/* <div className='w-fit absolute top-1/2 right-[50%] translate-x-1/2 -translate-y-1/2'>
                    <div className='relative'>
        ...
        <div className="w-full min-h-20 flex flex-col px-8">
          ...
          <div className="flex flex-col gap-1">
            <h1 className="text-[#272880] font-bold text-2xl">
              PRODUCT FEATURES
            </h1>
        ...
        <div className="w-full min-h-20 flex flex-col px-8">
          <div className="w-full flex flex-col">
            <h1 className="text-[#272880] font-bold text-2xl mb-1">
              TECHNICAL DATA
            </h1>
