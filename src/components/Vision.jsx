...
const Vision = () => {
  ...
  useEffect(() => {
    ...
    if (
      circles.length > 0 &&
      visionText.length > 0 &&
      visionPara1.length > 0 &&
      visionPara2.length > 0 &&
      visionPara3.length > 0 &&
      visionPara4.length > 0 &&
      visionPara5.length > 0
    ) {
  ...
  return (
    <>
      ...
      <div
        ref={containerRef}
        className="hidden md:hidden lg:flex page11 w-full min-h-[100vh] justify-start items-center pl-28 gap-5 -mt-[30vw]"
      >
        <div className="">
          <h1 className="vision-text text-stroke text-[#002A77] text-[7vw] tracking-wider">
            VISION
          </h1>
        </div>
        ...
        <div className="vision-para flex flex-col leading-none">
          <p className="para vision-para-1 text-[1.7vw] text-[#002A77]">
            "Creating futuristic solutions for the next
          </p>
          <p className="para vision-para-2 text-[1.7vw] text-[#002A77]">
            generation of global infrastructure through
          </p>
          <p className="para vision-para-3 text-[1.7vw] text-[#002A77]">
            innovative, sustainable, and revolutionary
          </p>
          <p className="para vision-para-4 text-[1.7vw] text-[#002A77]">
            electronic that set a new benchmark
          </p>
          <p className="para vision-para-5 text-[1.7vw] text-[#002A77]">
            for the industry."
          </p>
        </div>
      </div>
