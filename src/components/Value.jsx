  ...
  return (
    <>
      ...
      <div
        ...
        className="page13 hidden md:hidden lg:flex w-full min-h-screen justify-start items-center pl-28 gap-5 mt-[50vw]"
      >
        <div className="">
          <h1 className="value-text text-stroke text-[#002A77] text-[7vw] tracking-wider">
            VALUE
          </h1>
        </div>
        ...
        <div className="value-para flex flex-col gap-3 leading-none">
          <p className="para value-para-1 w-[35vw] text-[1.7vw] text-[#002A77]">
            <span className="font-bold">Safety: </span>Ensuring safety through a
            committed attitude towards people, property, and the workplace.
          </p>
          <p className="para value-para-2 w-[35vw] text-[1.7vw] text-[#002A77]">
            <span className="font-bold">Respect: </span>Valuing people, society,
            and the environment in all our actions and decisions.
          </p>
          <p className="para value-para-3 w-[35vw] text-[1.7vw] text-[#002A77]">
            <span className="font-bold">Transparency: </span>Maintaining
            openness and honesty in all our dealings and behaviour.
          </p>
          <p className="para value-para-4 w-[35vw] text-[1.7vw] text-[#002A77]">
            <span className="font-bold">Commitment: </span>Dedicating ourselves
            to personal and organizational development.
          </p>
          <p className="para value-para-5 w-[35vw] text-[1.7vw] text-[#002A77]">
            <span className="font-bold">Sustainability: </span>Mindful and
            judicious use of resources with respect to the elimination of toxic
            waste to foster a greener future.
          </p>
          <p className="para value-para-6 w-[35vw] text-[1.7vw] text-[#002A77]">
        ...
        <div className="flex w-full justify-center items-start gap-8 px-8">
          ...
          <motion.div className="flex flex-col gap-4 leading-snug overflow-hidden max-w-md">
            <motion.p
              ...
              viewport={{ once: true }}
              className="text-lg text-[#002A77]"
            >
              <span className="font-bold">Safety: </span>
              Ensuring safety through a committed attitude towards people,
            ...
            >
              ...
              Valuing people, society, and the environment in all our actions
              and decisions.
            </motion.p>
            ...
            >
              ...
              Maintaining openness and honesty in all our dealings and
              behaviour.
            </motion.p>
            ...
            >
              ...
              Dedicating ourselves to personal and organizational development.
            </motion.p>
            ...
            >
              ...
              Mindful and judicious use of resources with respect to the
              elimination of toxic waste to foster a greener future.
            </motion.p>
      ...
      <div className="flex md:hidden lg:hidden w-full min-h-screen flex-col justify-start items-center gap-6 -mt-[45vw]">
        ...
        <motion.div className="flex flex-col gap-3 leading-none overflow-hidden">
          ...
          >
            <span className="font-bold">Safety: </span>
            <br />
            Ensuring safety through a committed
            <br /> attitude towards people, property, and the workplace.
          </motion.p>
          ...
          >
            ...
            <br /> in our actions and decisions.
          </motion.p>
          ...
          >
            <span className="font-bold">Transparency: </span>
            <br />
            Maintaining openness and honesty in all our dealings and behaviour.
          </motion.p>
