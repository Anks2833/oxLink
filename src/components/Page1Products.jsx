  ...
  return (
    <>
      ...
      <div
        ...
        className="hidden md:hidden lg:flex relative w-full min-h-screen mt-[85vw] overflow-hidden"
      >
        <motion.h1
          ref={productText}
        ...
        {/* The blue div */}
        <div className="blue-div absolute z-[100] -top-52 -left-32 w-[380vw] h-[30vw] bg-[#c8e3ef]/70 -rotate-12 px-40 pt-10 flex overflow-hidden">
          <CircleGrp1 />
          <ProductsContent />
          <CircleGrp2 />
          <ProductsContent1 />
      ...
      <div className="hidden md:flex lg:hidden flex-col relative w-full min-h-screen">
        <motion.h1
          ...
          className="product-text text-black text-6xl md:text-7xl"
        >
          Products
        </motion.h1>

        {/* Products content container */}
        <div className="flex flex-col items-center md:max-w-4xl md:mx-auto md:px-6">
          <CircleGrp1 />
      ...
      {/* Mobile */}
      <div className="flex flex-col md:hidden lg:hidden relative w-full min-h-screen pt-20">
        <motion.h1
          initial={{ translate: "-100%", opacity: 0 }}
          whileInView={{ translate: "5%", opacity: 1 }}
          transition={{ duration: 1 }}
