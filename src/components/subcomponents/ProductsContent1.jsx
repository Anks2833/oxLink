...
const ProductsContent1 = () => {
  return (
    <>
      ...
      {/* Tablet */}
      <div className="hidden md:flex lg:hidden w-full flex-col gap-4 px-8 mt-24 mb-60 max-w-2xl mx-auto">
        <motion.div
          className="flex justify-center items-center gap-2"
          initial={{ x: -100, opacity: 0 }}
          whileInView={{ x: 0, opacity: 1 }}
          ...
          transition={{ duration: 0.5, delay: 0.1 }}
        >
          <h1 className="product-text font-semibold text-3xl">02.</h1>
          <h1 className="product-text font-semibold text-3xl">Data Cable</h1>
        </motion.div>
        ...
        <NavLink to="/data-cable" className="w-full flex justify-center mt-2">
      ...
      <div className="flex sm:hidden w-fit flex-col gap-2 border-r border-l border-l-black border-r-black px-5 mt-20 mb-52">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h1 className="product-text font-semibold text-2xl">02.</h1>
          <h1 className="product-text font-semibold text-2xl">Data Cable</h1>
        </motion.div>
